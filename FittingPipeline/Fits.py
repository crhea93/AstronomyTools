...
def PrimeFitting(base_directory,dir,file_name,num_files,redshift,n_H,Temp_guess,output_file,multi=False):
    ...
    for i in range(num_files):
        ...
        for directory in dir:
            try:
                spectrum_files.append(directory+'/repro/'+file_name+str(i+1)+".pi")
                background_files.append(directory+'/repro/'+file_name+str(i+1)+"_bkg.pi")
            except:
                pass
        #try:
        if multi.lower() == 'false':
    ...
    for i in range(num_files):
        ...
        for directory in dir:
            try:
                spectrum_files.append(directory+'/repro/'+file_name+str(i+1)+".deproj")
                background_files.append(directory+'/repro/'+file_name+str(i+1)+"_bkg.pi")
            except:
                pass
        #try:
